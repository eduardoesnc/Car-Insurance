...
st.markdown("""<p style="font-size: 16px;text-align: center; margin-top: -20px">
            A coluna da idade do carro apresentava alguns valores muito diferentes do comum, sendo assim foram removidas
            algumas linhas que apresentavam esses valores extremos.
            </p>""", unsafe_allow_html=True)

st.markdown("<br> <h4 style='text-align: center;'>Idade do segurado</h4>", unsafe_allow_html=True)
B1, B2 = st.columns(2)

with B1:
    st.markdown("<h5 style='text-align: center;margin-bottom: -34px;'>Antes</h5>", unsafe_allow_html=True)
    fig = px.box(bf, x='age_of_policyholder', labels={'age_of_car': 'Idade do segurado'}, width=400, height=300)
    st.write(fig)
...
st.markdown("""<p style="font-size: 16px;text-align: center; margin-top: -20px">
            A coluna da idade do segurado apresentava alguns valores muito diferentes do comum, sendo assim foram removidas
            algumas linhas que apresentavam esses valores extremos.
            </p>""", unsafe_allow_html=True)
